...
const TopSearch = ({ handleChange }) => {
    ...
    <input id="search-field" onChange={handleChange} className="lp pc ti aev ari atm ato axq bfy bmw chs" placeholder="Search..." type="search" name="search" />
</form>);
}
