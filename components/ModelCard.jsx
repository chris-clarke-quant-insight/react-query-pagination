        ...
        <div>
            <div className="sc-cnMZnH hSByNr">
                <section className="sc-cCmLNy lmddrv">
                    ...
                    <label htmlFor="qv7l6cqy8bST" data-testid="t_st_lbl" className="sc-gkSfol bLGwhT">ST</label>
                    <input type="radio" id="aatxwusy4rLT" data-testid="t_lt_btn" className="sc-fIhvWL iTAprC" value="lt" />
                    <label htmlFor="aatxwusy4rLT" data-testid="t_lt_lbl" className="sc-gkSfol bLGwhT">LT</label>
                </section>
                <section>
                    <input type="radio" id="t1bv4atspq2W" data-testid="t_twoWeeks_btn" className="sc-gzrROc gOPKWb" value="twoWeeks" />
                    <label htmlFor="t1bv4atspq2W" data-testid="t_twoWeeks_lbl" className="sc-fmPOXC hkggfk">2W</label>
                    <input type="radio" id="72kqlbykh11M" data-testid="t_oneMonth_btn" className="sc-gzrROc gOPKWb" value="oneMonth" />
                    <label htmlFor="72kqlbykh11M" data-testid="t_oneMonth_lbl" className="sc-fmPOXC hkggfk">1M</label>
                    <input type="radio" id="j6b1pdg50o2M" data-testid="t_twoMonths_btn" className="sc-gzrROc gOPKWb" value="twoMonths" />
                    <label htmlFor="j6b1pdg50o2M" data-testid="t_twoMonths_lbl" className="sc-fmPOXC hkggfk">2M</label>
                </section>
            </div>
        </div>
    </div>
